...
<body>
    <div class="py-14 px-4 w-full max-w-3xl mx-auto">
        <a id="logo-home-route" href="{{ route('home') }}" class="block mx-auto w-36 mb-8">
    ...
    if (data.tableCart.paymentMethod) {
        ...
        document.getElementById('logo-home-route').setAttribute('href', url + data.tableCart.table.slug );
    }
</script>
</body>
